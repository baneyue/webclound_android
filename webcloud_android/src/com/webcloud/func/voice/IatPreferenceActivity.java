 ...
 * @since 20120822
 */
public class IatPreferenceActivity extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //转写引擎列表.
        ListPreference engineListPreference =
            (ListPreference)findPreference(getString(R.string.preference_key_iat_engine));
    ...
    private String readStringFromFile(String fileName)
        ...
        BufferedReader reader = new BufferedReader(new InputStreamReader(getAssets().open(fileName), "UTF-16"));
    ...
    private JSONArray getDataSource() {
        if (null == mDataSource) {
            try {
                ...
                mDataSource = ((JSONObject)new JSONTokener(in).nextValue()).getJSONArray("provinces");
