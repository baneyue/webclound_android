...
public class CircleFlowIndicator extends View implements FlowIndicator,
    ...
    public CircleFlowIndicator(Context context, AttributeSet attrs) {
        ...
        int activeDefaultColor = 0xFF003399;
        ...
        // Retrieve the radius
        radius = a.getDimension(R.styleable.CircleFlowIndicator_radius, 7.0f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //this is the amount the home circle should be offset to make the entire thing centered
